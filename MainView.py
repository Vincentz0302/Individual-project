...
class MainView(wx.Panel):
    ...
    def __init__(self, parent, id):
        ...
        infoPanel = wx.Panel(self.op_notebook, -1, size = (800, 340))
        self.op_notebook.AddPage(infoPanel, "vid info")
        self.previewButton = wx.Button(infoPanel, -1, "Preview", pos = (5,5))
        self.showCurPosButton = wx.Button(infoPanel, -1, "Show Pos", pos = (105, 5))
        self.st_size = wx.StaticText(infoPanel, -1, size=(1,-1), pos = (605,5))
        self.st_len  = wx.StaticText(infoPanel, -1, size=(1,-1), pos = (605, 30))
        self.st_pos  = wx.StaticText(infoPanel, -1, size=(1,-1), pos = (605, 55))
        self.volumeSlider = wx.Slider(infoPanel, -1, 0, 0, 0, size=(600, -1), pos =(5,55) )
